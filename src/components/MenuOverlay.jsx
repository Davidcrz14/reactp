    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/davcrz/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/Davidcrz14/" target="_blank" rel="noopener noreferrer" aria-label="GitHub" data-social="github">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="mailto:davccorp@gmail.com" aria-label="Email" data-social="email">
            <div className="filled" />
            ...
            {isOpen && (
                <>
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.15 }} // Reduce duration for faster animation
                    ...
                    <motion.div
                        ...
                        animate={{ x: 0 }}
                        exit={{ x: "100%" }}
                        transition={{ type: "tween", duration: 0.2 }} // Reduce duration for faster animation
